<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="col-3">
            ...
            {{ Form::label('') }}
            {{ Form::select('tipo_id_paciente',$tiposidpacientes, $paciente->tipo_id_paciente, ['class' => 'form-control' . ($errors->has('tipo_id_paciente') ? ' is-invalid' : ''), 'placeholder' => 'Tipo Id Paciente']) }}
